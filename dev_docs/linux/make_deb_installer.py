...
deb_path = os.path.join(".", "musclex-{}_amd64(linux)".format(__version__), "DEBIAN")
exc_path = os.path.join(
    ".", "musclex-{}_amd64(linux)".format(__version__), "usr", "bin"
)
app_path = os.path.join(
    ".", "musclex-{}_amd64(linux)".format(__version__), "usr", "share", "applications"
)
png_path = os.path.join(
    ".", "musclex-{}_amd64(linux)".format(__version__), "usr", "share", "icons"
)
...
proc = subprocess.Popen(
    "fakeroot dpkg-deb --build musclex-{}_amd64\(linux\)".format(__version__),
    shell=True,
)
proc.communicate()
...
proc = subprocess.Popen(
    "lintian musclex-{}_amd64\(linux\).deb".format(__version__), shell=True
)
proc.communicate()
