...
### 5. Calculate R-min
For the background subtraction algorithms to work, it is necessary to define a [minimum radius R-min](../Common-Settings.md#r-min) to minimize the effects of the backstop. 
