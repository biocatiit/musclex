...
## Processes
### 1. [Find Center](https://github.com/biocatiit/musclex/wiki/Image-Processing-Functions#finding-center)
### 2. [Calculate Rotation Angle](https://github.com/biocatiit/musclex/wiki/Image-Processing-Functions#calculate-rotation-angle)
