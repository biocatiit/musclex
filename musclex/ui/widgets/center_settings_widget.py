...
class ApplyCenterDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.subsequentRadio.setToolTip(
            "Apply the current center to this image and all images after it in the folder"
        )
        self.previousRadio = QRadioButton("Apply to previous images")
        self.previousRadio.setToolTip(
            "Apply the current center to this image and all images before it in the folder"
        )
        self.allRadio = QRadioButton("Apply to all images")
        self.allRadio.setToolTip(
            "Apply the current center to every image in the folder"
        )
...
class RestoreAutoCenterDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.currentRadio.setToolTip(
            "Discard the manual center and recompute the automatic center for the current image only"
        )
        self.subsequentRadio = QRadioButton("Apply to subsequent images")
        self.subsequentRadio.setToolTip(
            "Recompute the automatic center for this image and all images after it in the folder"
        )
        self.previousRadio = QRadioButton("Apply to previous images")
        self.previousRadio.setToolTip(
            "Recompute the automatic center for this image and all images before it in the folder"
        )
        self.allRadio = QRadioButton("Apply to all images")
        self.allRadio.setToolTip(
            "Recompute the automatic center for every image in the folder"
        )
...
class CenterSettingsWidget(CollapsibleGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self.calibrationButton.setToolTip(
            "Open the calibration dialog and use the calibrated center for this image"
        )
        ...
        self.applyCenterBtn.setToolTip(
            "Copy the current center to other images in the folder (choose scope in dialog)"
        )
        self.restoreAutoCenterBtn = QPushButton("Restore Auto Center")
        self.restoreAutoCenterBtn.setToolTip(
            "Discard the manual center and revert selected images to auto-detected centers"
        )
