...
class ApplyRotationDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.subsequentRadio.setToolTip(
            "Apply the current rotation angle to this image and all images after it in the folder"
        )
        self.previousRadio = QRadioButton("Apply to previous images")
        self.previousRadio.setToolTip(
            "Apply the current rotation angle to this image and all images before it in the folder"
        )
        self.allRadio = QRadioButton("Apply to all images")
        self.allRadio.setToolTip(
            "Apply the current rotation angle to every image in the folder"
        )
...
class RestoreAutoRotationDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.currentRadio.setToolTip(
            "Discard the manual rotation and recompute the automatic angle for the current image only"
        )
        self.subsequentRadio = QRadioButton("Apply to subsequent images")
        self.subsequentRadio.setToolTip(
            "Recompute the automatic rotation angle for this image and all images after it"
        )
        self.previousRadio = QRadioButton("Apply to previous images")
        self.previousRadio.setToolTip(
            "Recompute the automatic rotation angle for this image and all images before it"
        )
        self.allRadio = QRadioButton("Apply to all images")
        self.allRadio.setToolTip(
            "Recompute the automatic rotation angle for every image in the folder"
        )
...
class AutoOrientationDialog(QDialog):
    ...
    def __init__(
        self,
        parent=None,
        current_orientation_model=None,
        mode_orientation_enabled=False,
    ):
        super().__init__(parent)
        ...
        self.modeAngleChkBx.setToolTip(
            "Use the most common orientation angle from all images in the folder"
        )
...
class RotationSettingsWidget(CollapsibleGroupBox):
    ...
    def __init__(
        ...
        self.setAutoOrientationBtn.setToolTip(
            "Open the auto orientation dialog to choose the algorithm used to detect the rotation angle"
        )
        ...
        self.applyRotationBtn.setToolTip(
            "Copy the current rotation angle to other images in the folder (choose scope in dialog)"
        )
        self.restoreAutoRotationBtn = QPushButton("Restore Auto Rotation")
        self.restoreAutoRotationBtn.setToolTip(
            "Discard the manual rotation and revert selected images to auto-detected angles"
        )
