...
class AddIntensitiesSingleExp(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.calc_diff_btn = QPushButton("Calculate Image Differences")
        ...
        self.radio_rot_absolute = QRadioButton("Align to Horizontal Equator")
        self.radio_rot_absolute.setChecked(True)
        self.radio_rot_diff = QRadioButton("Align to Base Rotation")
